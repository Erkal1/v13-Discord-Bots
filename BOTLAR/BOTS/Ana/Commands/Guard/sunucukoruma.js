...
class SunucuKoruma extends Command {
 ...
 Lütfen aç/kapat/log olmak üzere geçerli bir eylem belirtin ${emojiler.dikkat}

 Sunucu koruma şuanda; ${utils.get("serverGuard").value() ? `${emojiler.turnon}` : `${emojiler.turnoff}`}
 `)]
      })
